  ...
  return (
    <section className="mx-auto grid max-w-[1200px] grid-cols-1 gap-16 border-b border-[var(--gold-dim)] px-6 py-16 sm:px-10 md:grid-cols-2 md:gap-20 md:px-16 md:py-20 lg:px-[72px]">
      <div>
        ...
        <h2 className="mb-5 font-[family-name:var(--font-cormorant)] text-[32px] font-light leading-tight text-[var(--cream)] md:text-[38px]">
          Every slab is a one-of-a-kind object. No two will ever exist.
        </h2>
        <p className="text-[13px] font-light leading-[1.9] text-[rgba(242,237,227,0.7)]">
...
function IntroStat({ n, label }: { n: string; label: string }) {
  return (
    <div className="border-l border-[var(--gold-dim)] pl-6">
      <div className="font-[family-name:var(--font-cormorant)] text-[44px] font-light leading-none text-[var(--gold)]">
        {n}
      </div>
      <div className="mt-1.5 text-[8px] font-extralight uppercase tracking-[0.2em] text-[rgba(242,237,227,0.7)]">
        {label}
      </div>
    </div>
  );
